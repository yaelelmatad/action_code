...
action: build/main.o build/config.o build/slice.o build/trajectory.o
#action: main.o config.o slice.o trajectory.o
	g++ -o action build/main.o build/config.o build/slice.o build/trajectory.o
...
clean:
	rm action build/main.o build/config.o build/slice.o build/trajectory.o
